...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-xl border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "line-clamp-1 flex w-fit items-center gap-2 text-sm leading-snug font-semibold tracking-tight underline-offset-4",
        className
      )}
      {...props}
    />
